...
Refer to koheesio.steps.writers.buffer for more details on the BufferWriter interface.
...
from koheesio.steps.writers.buffer import (
    BufferWriter,
...
class SendCsvToSftp(PandasCsvBufferWriter, SFTPWriter):
    ...
    -------
    ```python
    from koheesio.steps.writers import SendCsvToSftp
...
class SendJsonToSftp(PandasJsonBufferWriter, SFTPWriter):
    ...
    -------
    ```python
    from koheesio.steps.writers import SendJsonToSftp
