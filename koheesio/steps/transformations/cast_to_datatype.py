...
- for dates, use the [koheesio.steps.transformations.date_time](date_time) module
- for arrays, use the [koheesio.steps.transformations.arrays](arrays.html) module
...
class CastToTimestamp(CastToDatatype):
    ...
    See Also
    --------
    * [koheesio.steps.transformations.date_time](date_time)
