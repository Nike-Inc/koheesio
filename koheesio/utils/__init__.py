...
# add spark utils if pyspark is available
try:
    from koheesio.utils.spark_utils import SparkDatatype
    from koheesio.utils.spark_utils import __all__ as __spark_utils__all__
    from koheesio.utils.spark_utils import (
    ...
    __all__.extend(__spark_utils__all__)
except ImportError:
    pass
