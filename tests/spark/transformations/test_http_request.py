...
# using a python instead of a text file to preserve the correct formatting of new lines and tabs
@pytest.fixture
def expected_data():
    return [
...
class TestHttpRequestTransformation:
    ...
    def test_downloading_files(self, input_df: DataFrame, download_path: Path, expected_data) -> None:
